...
def get_blog_list_common_data(request, blogs_all_list):
    ...
    context['blog_types'] = BlogType.objects.annotate(blog_count=Count('blog'))  # 小写的blog反向关联Blog
...
def blog_detail(request, blog_pk):
    ...
    # CommentForm(initial={'content_type': blog_content_type.model, 'object_id': blog_pk,'reply_comment_id':0})
